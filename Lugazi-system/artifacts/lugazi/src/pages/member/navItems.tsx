...
import { LayoutDashboard, User, CalendarCheck, CalendarDays, Heart, ArrowUpCircle } from "lucide-react";
...
export const memberNavItems: NavItem[] = [
  ...
  { label: "My QR Code", href: "/member/qr", icon: <LayoutDashboard className="h-4 w-4" /> },
];
