              ...
              <div>
                ...
                <ResponsiveContainer width="100%" height={150}>
                  <PieChart>
                    ...
                    <Tooltip contentStyle={{ backgroundColor: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: '8px', color: 'hsl(var(--foreground))', fontSize: 12 }} labelStyle={{ color: 'hsl(var(--muted-foreground))' }} itemStyle={{ color: 'hsl(var(--foreground))' }} formatter={(v: number, name: string) => [`${v} birthday${v !== 1 ? "s" : ""}`, name]} />
          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={120}>
              <AreaChart data={monthData} margin={{ top: 0, right: 4, left: -24, bottom: 0 }}>
                ...
                <Tooltip contentStyle={{ backgroundColor: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: '8px', color: 'hsl(var(--foreground))', fontSize: 12 }} labelStyle={{ color: 'hsl(var(--muted-foreground))' }} itemStyle={{ color: 'hsl(var(--foreground))' }} formatter={(v: number) => [`${v}`, "Members"]} />
