...
// Inline Google "G" SVG — no extra package needed
function GoogleIcon() {
  return (
...
export default function Login() {
  ...
  // Handle error params from Google OAuth redirect (e.g. ?error=google_denied)
  useEffect(() => {
    ...
    // Clean the URL so the error doesn't re-show on refresh
  ...
  function handleGoogleSignIn() {
    // Full page navigation — backend handles the OAuth redirect chain
