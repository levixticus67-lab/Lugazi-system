import { useState, useEffect } from "react";
  ...
  export default function LeadershipProfile() {
    ...
    if (isLoading) return <PortalLayout navItems={leadershipNavItems} portalLabel="Leadership Portal"><div className="text-muted-foreground p-6">Loading...</div></PortalLayout>;
