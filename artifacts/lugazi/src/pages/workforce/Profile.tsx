...
export default function WorkforceProfile() {
  ...
  if (isLoading) return <PortalLayout navItems={workforceNavItems} portalLabel="Workforce Portal"><div className="text-muted-foreground">Loading...</div></PortalLayout>;
          ...
          <div className="flex items-center gap-3 py-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 mt-0.5">
                ...
                <span className="text-xs text-indigo-500 font-medium capitalize">{me?.role}</span>
              </div>
