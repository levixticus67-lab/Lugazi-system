import { useState } from "react";
  ...
  export default function WorkforceWelfare() {
    ...
    return (
      <PortalLayout navItems={workforceNavItems} portalLabel="Workforce Portal">
        <PageHeader title="Welfare Requests" description="Submit and track your welfare requests" actions={
          <Button size="sm" onClick={() => setShowAdd(true)} className="blue-gradient-bg text-white border-0 hover:opacity-90"><Plus className="h-4 w-4 mr-1" /> New Request</Button>
        } />
        <DataTable
          columns={[
        ...
        <Dialog open={showAdd} onOpenChange={setShowAdd}>
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <div><Label>Description</Label><Textarea rows={3} value={form.description} onChange={e => f("description", e.target.value)} placeholder="Describe your need..." /></div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSubmit} disabled={createMutation.isPending} className="blue-gradient-bg text-white border-0 hover:opacity-90">Submit</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </PortalLayout>
