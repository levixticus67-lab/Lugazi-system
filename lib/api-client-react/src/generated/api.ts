...
export const updateUserRole = async (id: number,
    roleChange: RoleChange, options?: Parameters<typeof customFetch>[1]): Promise<UserProfile> => {
...
export const getUpdateUserRoleMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateUserRole>>, TError,{id: number;data: BodyType<RoleChange>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateUserRole>>, TError,{id: number;data: BodyType<RoleChange>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateUserRole>>, {id: number;data: BodyType<RoleChange>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 */
export const listRoleRequests = async ( options?: Parameters<typeof customFetch>[1]): Promise<RoleRequest[]> => {
...
export const getListRoleRequestsQueryOptions = <TData = Awaited<ReturnType<typeof listRoleRequests>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listRoleRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListRoleRequestsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listRoleRequests>>> = ({ signal }) => listRoleRequests({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listRoleRequests>>, TError, TData> & { queryKey: QueryKey }
}

export type ListRoleRequestsQueryResult = NonNullable<Awaited<ReturnType<typeof listRoleRequests>>>
...
export function useListRoleRequests<TData = Awaited<ReturnType<typeof listRoleRequests>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listRoleRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const createRoleRequest = async (roleRequestInput: RoleRequestInput, options?: Parameters<typeof customFetch>[1]): Promise<RoleRequest> => {
...
export const getCreateRoleRequestMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createRoleRequest>>, TError,{data: BodyType<RoleRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createRoleRequest>>, TError,{data: BodyType<RoleRequestInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createRoleRequest>>, {data: BodyType<RoleRequestInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateRoleRequestMutationResult = NonNullable<Awaited<ReturnType<typeof createRoleRequest>>>
 ...
 * @summary Submit a role upgrade request
 */
export const useCreateRoleRequest = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createRoleRequest>>, TError,{data: BodyType<RoleRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const approveRoleRequest = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<RoleRequest> => {
...
export const getApproveRoleRequestMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof approveRoleRequest>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof approveRoleRequest>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof approveRoleRequest>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ApproveRoleRequestMutationResult = NonNullable<Awaited<ReturnType<typeof approveRoleRequest>>>
 ...
 * @summary Approve a role upgrade request (admin only)
 */
export const useApproveRoleRequest = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof approveRoleRequest>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const rejectRoleRequest = async (id: number,
    roleRequestReject: RoleRequestReject, options?: Parameters<typeof customFetch>[1]): Promise<RoleRequest> => {
...
export const getRejectRoleRequestMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rejectRoleRequest>>, TError,{id: number;data: BodyType<RoleRequestReject>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof rejectRoleRequest>>, TError,{id: number;data: BodyType<RoleRequestReject>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof rejectRoleRequest>>, {id: number;data: BodyType<RoleRequestReject>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RejectRoleRequestMutationResult = NonNullable<Awaited<ReturnType<typeof rejectRoleRequest>>>
 ...
 * @summary Reject a role upgrade request (admin only)
 */
export const useRejectRoleRequest = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rejectRoleRequest>>, TError,{id: number;data: BodyType<RoleRequestReject>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getMemberQr = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MemberQr> => {
...
export const getGetMemberQrQueryOptions = <TData = Awaited<ReturnType<typeof getMemberQr>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMemberQr>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetMemberQrQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMemberQr>>> = ({ signal }) => getMemberQr(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMemberQr>>, TError, TData> & { queryKey: QueryKey }
}

export type GetMemberQrQueryResult = NonNullable<Awaited<ReturnType<typeof getMemberQr>>>
...
export function useGetMemberQr<TData = Awaited<ReturnType<typeof getMemberQr>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMemberQr>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const checkIn = async (checkInInput: CheckInInput, options?: Parameters<typeof customFetch>[1]): Promise<AttendanceRecord> => {
 ...
 */
export const qrScanCheckIn = async (qrScanInput: QrScanInput, options?: Parameters<typeof customFetch>[1]): Promise<AttendanceRecord> => {
...
export const getQrScanCheckInMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof qrScanCheckIn>>, TError,{data: BodyType<QrScanInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof qrScanCheckIn>>, TError,{data: BodyType<QrScanInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof qrScanCheckIn>>, {data: BodyType<QrScanInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type QrScanCheckInMutationResult = NonNullable<Awaited<ReturnType<typeof qrScanCheckIn>>>
 ...
 * @summary Check in via QR code scan — resolves member by QR token and records attendance
 */
export const useQrScanCheckIn = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof qrScanCheckIn>>, TError,{data: BodyType<QrScanInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getUploadSignature = async ( options?: Parameters<typeof customFetch>[1]): Promise<UploadSignature> => {
...
export const getGetUploadSignatureQueryOptions = <TData = Awaited<ReturnType<typeof getUploadSignature>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUploadSignature>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetUploadSignatureQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getUploadSignature>>> = ({ signal }) => getUploadSignature({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getUploadSignature>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetUploadSignature<TData = Awaited<ReturnType<typeof getUploadSignature>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUploadSignature>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const listWelfare = async ( options?: Parameters<typeof customFetch>[1]): Promise<WelfareRequest[]> => {
...
export const getListWelfareQueryOptions = <TData = Awaited<ReturnType<typeof listWelfare>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listWelfare>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListWelfareQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listWelfare>>> = ({ signal }) => listWelfare({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listWelfare>>, TError, TData> & { queryKey: QueryKey }
}

export type ListWelfareQueryResult = NonNullable<Awaited<ReturnType<typeof listWelfare>>>
...
export function useListWelfare<TData = Awaited<ReturnType<typeof listWelfare>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listWelfare>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const createWelfare = async (welfareInput: WelfareInput, options?: Parameters<typeof customFetch>[1]): Promise<WelfareRequest> => {
...
export const getCreateWelfareMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createWelfare>>, TError,{data: BodyType<WelfareInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createWelfare>>, TError,{data: BodyType<WelfareInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createWelfare>>, {data: BodyType<WelfareInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateWelfareMutationResult = NonNullable<Awaited<ReturnType<typeof createWelfare>>>
 ...
 * @summary Submit a welfare request
 */
export const useCreateWelfare = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createWelfare>>, TError,{data: BodyType<WelfareInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const updateWelfare = async (id: number,
    welfareUpdate: WelfareUpdate, options?: Parameters<typeof customFetch>[1]): Promise<WelfareRequest> => {
...
export const getUpdateWelfareMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateWelfare>>, TError,{id: number;data: BodyType<WelfareUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateWelfare>>, TError,{id: number;data: BodyType<WelfareUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateWelfare>>, {id: number;data: BodyType<WelfareUpdate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateWelfareMutationResult = NonNullable<Awaited<ReturnType<typeof updateWelfare>>>
 ...
 * @summary Update welfare request status (admin/leadership)
 */
export const useUpdateWelfare = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateWelfare>>, TError,{id: number;data: BodyType<WelfareUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const listPipeline = async ( options?: Parameters<typeof customFetch>[1]): Promise<PipelineContact[]> => {
 ...
 */
export const createPipelineContact = async (pipelineInput: PipelineInput, options?: Parameters<typeof customFetch>[1]): Promise<PipelineContact> => {
...
export const getCreatePipelineContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createPipelineContact>>, TError,{data: BodyType<PipelineInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createPipelineContact>>, TError,{data: BodyType<PipelineInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createPipelineContact>>, {data: BodyType<PipelineInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreatePipelineContactMutationResult = NonNullable<Awaited<ReturnType<typeof createPipelineContact>>>
 ...
 * @summary Add a pipeline contact
 */
export const useCreatePipelineContact = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createPipelineContact>>, TError,{data: BodyType<PipelineInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const updatePipelineContact = async (id: number,
    pipelineUpdate: PipelineUpdate, options?: Parameters<typeof customFetch>[1]): Promise<PipelineContact> => {
...
export const getUpdatePipelineContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePipelineContact>>, TError,{id: number;data: BodyType<PipelineUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePipelineContact>>, TError,{id: number;data: BodyType<PipelineUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePipelineContact>>, {id: number;data: BodyType<PipelineUpdate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePipelineContactMutationResult = NonNullable<Awaited<ReturnType<typeof updatePipelineContact>>>
 ...
 * @summary Update pipeline contact stage
 */
export const useUpdatePipelineContact = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePipelineContact>>, TError,{id: number;data: BodyType<PipelineUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const deletePipelineContact = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<void> => {
...
export const getDeletePipelineContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePipelineContact>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deletePipelineContact>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deletePipelineContact>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeletePipelineContactMutationResult = NonNullable<Awaited<ReturnType<typeof deletePipelineContact>>>
 ...
 * @summary Delete pipeline contact
 */
export const useDeletePipelineContact = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePipelineContact>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getMemberStats = async ( options?: Parameters<typeof customFetch>[1]): Promise<MemberStats> => {
 ...
 */
export const listUserSessions = async (params: ListUserSessionsParams, options?: Parameters<typeof customFetch>[1]): Promise<ActiveSession[]> => {

  return customFetch<ActiveSession[]>(getListUserSessionsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListMemberSessionsUrl = (memberId: number,) => {




  return `/api/admin/members/${memberId}/sessions`
}

/**
 * @summary List active sessions for a member (admin only)
 */
export const listMemberSessions = async (memberId: number, options?: Parameters<typeof customFetch>[1]): Promise<ActiveSession[]> => {

  return customFetch<ActiveSession[]>(getListMemberSessionsUrl(memberId),
  {
    ...options,
    method: 'GET'
...
export const getListMemberSessionsQueryKey = (memberId: number,) => {
    return [
    `/api/admin/members/${memberId}/sessions`
    ] as const;
    }


export const getListMemberSessionsQueryOptions = <TData = Awaited<ReturnType<typeof listMemberSessions>>, TError = ErrorType<unknown>>(memberId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listMemberSessions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListMemberSessionsQueryKey(memberId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listMemberSessions>>> = ({ signal }) => listMemberSessions(memberId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: memberId !== null && memberId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listMemberSessions>>, TError, TData> & { queryKey: QueryKey }
}

export type ListMemberSessionsQueryResult = NonNullable<Awaited<ReturnType<typeof listMemberSessions>>>
export type ListMemberSessionsQueryError = ErrorType<unknown>
...
export function useListMemberSessions<TData = Awaited<ReturnType<typeof listMemberSessions>>, TError = ErrorType<unknown>>(
 memberId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listMemberSessions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListMemberSessionsQueryOptions(memberId,options)
 ...
 */
export const getSettings = async ( options?: Parameters<typeof customFetch>[1]): Promise<ChurchSettings> => {
 ...
 */
export const updateSettings = async (settingsUpdate: SettingsUpdate, options?: Parameters<typeof customFetch>[1]): Promise<ChurchSettings> => {
